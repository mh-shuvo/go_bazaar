...
@section("title","কর্মীর বিক্রয় রিপোর্ট")
@section("content")
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div>
                    <h4 class="header-title mb-3">কর্মীর বিক্রয় রিপোর্ট</h4>
                </div>
            </div>
        </div>
        <!-- end row -->
             <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <form method="get" action="{{route('employe.sale_report.download')}}" target="__blank"> 
                                    @csrf
                                <div class="row">
